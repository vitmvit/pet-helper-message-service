    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers(HttpMethod.GET, "/api/v1/chats/**").hasAnyRole("VET", "SUPPORT", "USER").requestMatchers(HttpMethod.GET, "/api/v1/chats").hasAnyRole("VET", "SUPPORT", "USER")
                        .requestMatchers(HttpMethod.POST, "/api/v1/chats/**").hasAnyRole("VET", "SUPPORT", "USER").requestMatchers(HttpMethod.POST, "/api/v1/chats").hasAnyRole("VET", "SUPPORT", "USER")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/chats/**").hasAnyRole("VET", "SUPPORT", "USER").requestMatchers(HttpMethod.PUT, "/api/v1/chats").hasAnyRole("VET", "SUPPORT", "USER")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/chats/**").hasAnyRole("VET", "SUPPORT", "USER").requestMatchers(HttpMethod.DELETE, "/api/v1/chats").hasAnyRole("VET", "SUPPORT", "USER")
